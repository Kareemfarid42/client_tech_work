...
const leaders = [
  ...
  { name: "Michael Chen", role: "Chief Technology Officer", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face" },
  { name: "Emily Rodriguez", role: "VP of Marketing", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=300&h=300&fit=crop&crop=face" },
  { name: "David Kim", role: "Head of Strategy", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face" },
];
      ...
      <main>
        ...
        <section ref={whyRef} className="py-20 lg:py-32 bg-background">
          <div className="container-max section-padding">
            ...
            >
              <div>
                <div className="text-3xl lg:text-4xl font-display font-bold text-primary">10+</div>
              ...
              <div>
                <div className="text-3xl lg:text-4xl font-display font-bold text-primary">$500M+</div>
        ...
        <section ref={globalRef} className="py-20 lg:py-32 bg-secondary">
          <div className="container-max section-padding">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {locations.map((location, index) => (
                ...
                >
                  ...
                  <h3 className="font-display font-bold text-card-foreground">{location.city}</h3>

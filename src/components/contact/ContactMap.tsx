...
const ContactMap = () => {
    return (
        ...
        >
            <iframe
                src="https://maps.google.com/maps?q=Sacramento,+CA+95814&t=&z=13&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="100%"
            ...
            <div className="absolute inset-0 bg-[#0ea5e9]/5 pointer-events-none mix-blend-overlay"></div>
        </motion.div>
    );
};

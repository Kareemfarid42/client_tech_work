...
import { HsContactModal } from "./HsContactModal";

interface HsDemoModalProps {
    children: React.ReactNode;
}

export const HsDemoModal = ({ children }: HsDemoModalProps) => {
            ...
            <DialogContent className="max-w-3xl bg-[#0a0a0a] border-[#333333] p-0 overflow-hidden rounded-3xl shadow-2xl">
                <div className="relative group overflow-hidden bg-black aspect-[21/9] flex items-center justify-center border-b border-white/10">
                    ...
                    <div className="absolute bottom-3 left-5 right-5 z-10">
                        <p className="text-white font-bold text-base mb-0">ClienTech Home Services System Walkthrough</p>
                ...
                <div className="p-5 bg-[#0a0a0a]">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2">
                            {[
                                "Automated Lead Capture & Local SEO Systems",
                                "AI-Driven Client Qualification",
                                "Real-time Job Pipeline Management Dashboard",
                                "Automated Follow-up & Referral Workflows"
                            ].map((item, i) => (

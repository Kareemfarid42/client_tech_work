                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-heading font-bold text-white mb-6">
                            Eradicate <span className="text-red-500">Render-Blocking</span> Latency.
                        </h2>
                        <p className="text-[#888888] text-lg leading-relaxed mb-6 font-sans">
                            Sub-second load times aren't achieved by compressing images. They are achieved by restructuring the execution order of your application's critical rendering path.
                        </p>
                        <p className="text-[#888888] text-lg leading-relaxed mb-8 font-sans">
                            Our audit visualizes exactly where your request waterfalls are stalling, pinpointing the precise line of code or third-party script responsible for the delay.
                        </p>
                        ...
                        <div className="grid grid-cols-2 gap-6 border-t border-[#333333] pt-8">
                            ...
                            <div>
                                <div className="text-[#555] text-xs font-mono uppercase tracking-widest mb-1">Optimized Standard</div>
                                <div className="text-[#0ea5e9] text-3xl font-mono">0.1<span className="text-sm text-[#888]">s</span></div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <div className="relative bg-[#0a0a0a] rounded-2xl border border-[#333333] p-6 md:p-8 shadow-[0_0_30px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="space-y-3 relative">
                            <div className="absolute -left-3 top-1/2 -translate-y-1/2 w-1 h-12 bg-[#0ea5e9]/20 rounded-full" />
                            <div className="text-xs font-mono text-[#0ea5e9] mb-2 font-bold tracking-wider">OPTIMIZED EXECUTION</div>
                            ...
                            <div className="w-full flex border-l-2 border-dashed border-[#333] ml-[10%] space-x-1">
                                <motion.div initial={{ width: 0 }} whileInView={{ width: "15%" }} transition={{ duration: 1, delay: 1.0 }} className="h-6 bg-[#0ea5e9]/80 rounded-sm relative shadow-[0_0_10px_rgba(14,165,233,0.3)]">
                                    <span className="absolute left-2 top-1.5 text-[9px] text-white font-mono font-bold font-mono">critical.css</span>
                                </motion.div>
                                <motion.div initial={{ width: 0 }} whileInView={{ width: "25%" }} transition={{ duration: 1, delay: 1.0 }} className="h-6 bg-[#0ea5e9]/40 rounded-sm relative border border-[#0ea5e9]/50">
                                    <span className="absolute left-2 top-1.5 text-[9px] text-white font-mono">app-defer.js</span>
                                </motion.div>
                            </div>

                            {/* FCP marker */}
                            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 2.0 }} className="absolute left-[25%] top-0 bottom-0 w-px bg-[#0ea5e9]/80 shadow-[0_0_8px_rgba(14,165,233,0.8)] z-10">
                                <span className="absolute -bottom-5 left-0 text-[#0ea5e9] font-bold text-[10px] font-mono whitespace-nowrap -translate-x-1/2">LCP: 0.4s</span>
                            </motion.div>
                        </div>

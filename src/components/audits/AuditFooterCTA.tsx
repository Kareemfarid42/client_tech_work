        ...
        <section className="py-24 relative overflow-hidden bg-[#0a0a0a]">
            ...
            <div className="container-max section-padding relative z-10">
                ...
                >
                    ...
                    <button
                        onClick={onOpenModal}
                        className="mb-12 w-full sm:w-auto relative overflow-hidden group bg-[#17aa8c] text-black font-bold uppercase tracking-wider py-5 px-12 rounded-sm transition-all duration-300 hover:shadow-[0_0_40px_rgba(23,170,140,0.5)] hover:scale-105"
                    >
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 pt-8 border-t border-[#333333] w-full max-w-3xl">

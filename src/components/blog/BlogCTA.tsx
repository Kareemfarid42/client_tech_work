        ...
        >
            <div className="relative overflow-hidden rounded-3xl bg-[#0a0a0a] border border-[#333333] p-10 md:p-16 text-center flex flex-col items-center">
                ...
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                    <div className="absolute -top-24 -left-24 w-64 h-64 bg-[#0ea5e9] rounded-full mix-blend-screen filter blur-[100px] opacity-20" />
                    ...
                    <form className="w-full relative flex flex-col sm:flex-row items-center gap-3">
                        <div className="relative w-full flex-grow">
                            <input
                                ...
                                required
                                className="w-full bg-[#111111] border border-[#333333] text-white rounded-full py-4 pl-6 pr-4 focus:outline-none focus:border-[#0ea5e9] focus:ring-1 focus:ring-[#0ea5e9] transition-all placeholder:text-[#555555]"
                            />
                        </div>
                        <button
                            type="button"
                            className="w-full sm:w-auto flex-shrink-0 flex items-center justify-center gap-2 bg-[#0ea5e9] hover:bg-[#0284c7] text-white font-semibold py-4 px-8 rounded-full transition-all shadow-[0_0_20px_rgba(14,165,233,0.3)] hover:shadow-[0_0_30px_rgba(14,165,233,0.5)]"
                        >
                            Subscribe Now
